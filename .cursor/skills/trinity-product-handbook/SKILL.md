...
| 任务 | 必读 |
|------|------|
| 结构、新建页、四段、禁止项 | `apps/trinity-product/docs/产品手册文档规范.md` |
...
| 新建/改单个模块说明与子能力 | 叶子页 | `./references/template-leaf.md` |
| 需求说明页（无子能力表） | 需求型叶子 | `./references/template-requirements-leaf.md` |
...
| `template-leaf.md` | 标准叶子四段 |
| `template-requirements-leaf.md` | 需求型叶子 |
