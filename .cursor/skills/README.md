...
| TRTC Chat IM | [chat](./chat/SKILL.md) | 产品手册 |
...
| `trinity-design-tokens/` | token / design-spec |
| `trinity-tob-marketing-site/` | 营销页 |
| `trinity-user-console/` | 控制台 |
| `trinity-admin-ruoyi-list/` | 后台列表 |
| `chat/` | IM（重；未纳入 git 时本地可选） |
...
手册文档真源：`apps/trinity-product/docs/产品手册文档规范.md` · `产品手册更新规范.md`
