...
- **[info]** supplier_price_gap · `qwen3.5-plus` · bailian · 百炼同档价格与官方不一致（已登记例外）
- **[info]** supplier_price_gap · `qwen3.5-plus` · bailian · 百炼同档价格与官方不一致（已登记例外）
- **[info]** supplier_price_gap · `qwen3.5-flash` · bailian · 百炼同档价格与官方不一致（已登记例外）
- **[info]** supplier_price_gap · `qwen3.5-flash` · bailian · 百炼同档价格与官方不一致（已登记例外）
- **[info]** supplier_price_gap · `qwen3.5-flash` · bailian · 百炼同档价格与官方不一致（已登记例外）
- **[info]** supplier_tier_gap · `glm-4-7-251222` · bailian · 百炼档位数少于官方（已登记例外）
- **[warn]** supplier_price_gap · `glm-5` · bailian · 百炼同档价格与官方不一致
- **[warn]** supplier_price_gap · `glm-5` · bailian · 百炼同档价格与官方不一致
- **[warn]** supplier_price_gap · `glm-5.1` · bailian · 百炼同档价格与官方不一致
- **[warn]** supplier_price_gap · `glm-5.1` · bailian · 百炼同档价格与官方不一致
- **[error]** supplier_tier_gap · `minimax-m3` · bailian · 百炼档位数少于官方
