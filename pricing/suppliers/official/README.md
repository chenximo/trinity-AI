...
线上刊例如何从本目录官方锚算出，见产品真源：

**[../../docs/刊例策略-V1-V2-国际站优先.md](../../docs/刊例策略-V1-V2-国际站优先.md)**

要点：

- **V1**：国内站 CNY ÷ **6.5** → USD（历史/回退）  
- **V2（默认生效）**：同一厂商若有**官网国际站**价 → 用国际站；否则 = V1  
- **不是**百炼国际 / AIGC 国际等转售挂牌  
- Catalog / seed 需能挂 **domestic + international** 两套 `docUrl`/`pricingUrl`（落地时扩展；采集清单见该文 §7）
