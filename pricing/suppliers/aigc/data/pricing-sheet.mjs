...
export const PRICING_SHEET = [
    ...
    tiers: [
      {
        ...
        domestic: { input: "1.2", cache: "0.6", output: "4.8" },
      },
      {
        attribute: "输入长度(16k,32k]",
        domestic: { input: "1.6", cache: "0.8", output: "6.4" },
      },
      {
        attribute: "输入长度(32k,-]",
        domestic: { input: "2", cache: "1", output: "8" },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tiers: [
      {
        attribute: "统一价",
        domestic: { input: "9.375", cache: "0.9375", output: "75" },
        international: { input: "1.25", cache: "0.125", output: "10" },
      },
    ],
  },
  {
    ...
    tiers: [
      {
        attribute: "统一价",
        domestic: { input: "0.375", cache: "0.0375", output: "3" },
  ...
  },
  {
    ...
    tiers: [
      {
        attribute: "统一价",
        domestic: { input: "13.125", cache: "1.3125", output: "105" },
  ...
  },
  {
    ...
    tiers: [
      {
        attribute: "输入<=272K context",
        domestic: { input: "18.75", cache: "1.875", output: "112.5" },
        international: { input: "2.5", cache: "0.25", output: "15" },
      },
      {
        attribute: "输入>272K context",
  ...
  },
  {
    ...
    tiers: [
      {
        attribute: "统一价",
        domestic: { input: "5.625", cache: "0.5625", output: "33.75" },
