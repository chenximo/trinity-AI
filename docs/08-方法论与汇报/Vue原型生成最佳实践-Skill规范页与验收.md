...
ToB 营销官网已落地示例：Skill **`trinity-tob-marketing-site`** · 视觉验收 **`/design-tokens`**、**`/design-spec`**、样例 **`/ai-cloud`** · 文档 **`docs/08-方法论与汇报/AI实现Tob官网原型方法论/`**。
...
| ToB 营销官网 | `.cursor/skills/trinity-tob-marketing-site/SKILL.md` · `docs/08-方法论与汇报/AI实现Tob官网原型方法论/` |
