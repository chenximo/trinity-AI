...
import { useConsoleLinkInterceptor, useGeoConsoleBodyClass } from "./shellInteractions";
import "./shell.css";

const route = useRoute();
const onMainClick = useConsoleLinkInterceptor();
...
<template>
  <div class="geo-console" @click="onMainClick">
    <!-- 顶栏 -->
