...
| 项 | 共识 |
|----|------|
| **首要用户** | **全球化产品**的内容 / SEO / 营销负责人——在多市场被用户选型、对比、推荐时，需要占据 AI 答案（以官网、文档等 Web 内容为信源载体） |
| **典型样本** | **Trinity AI** 大模型 API 聚合平台：国内与海外开发者均使用，需在 ChatGPT、豆包等答案的「选型 / 对比」类目中有稳定 SOA |
| **重要子集** | 中国团队管理的跨境 / **出海品牌**（需在**同一面板**看海外 + 国内 AI，不必拼两套工具） |
| **次要用户** | 代理商多客户管理（首期账户级单品牌或多品牌；完整多租户见 P2） |
| **非目标** | 纯本地生活 / POI、无 Web 资产的小程序私域、纯国内服务商交付型 GEO、大企业纯定制项目（首期不做） |

### 0.2 产品一句话

**帮助全球化产品在海外与国内主流 AI 平台上，用 SOA 与竞品对比讲清「有没有进答案」，并完成诊断→优化→验证闭环的 GEO SaaS。**

差异化不靠功能数量，靠 **双市场平台覆盖** + **平价全功能**（相对 Tier 1 竞品）——「海外 + 中国同屏」是 **能力楔子**，不是把 ICP 收窄为「只做出海」。
...
> 备选/轮换：Grok、Google AI Mode 等海外引擎；元宝、智谱等国内引擎。首期 **不追求** Profound 式 8+ 海外全覆盖，优先 **全球化产品双市场最小闭环**（MVP 样本：Trinity AI API 聚合）。
...
| 2026-06-12 | **§0.1 ICP 调整**：首要用户由「出海品牌」改为 **全球化产品**；Trinity AI 为典型样本；出海为重要子集；双市场同屏为差异化楔子 |
