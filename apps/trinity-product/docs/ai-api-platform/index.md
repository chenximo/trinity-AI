...
::: tip 本阶段写法
**当前已做** / **5.30 能力** / **6.30 能力** 用 **✅ 🟡 ⬜** 填写；**5.30 商用** 已上线，**6.30 商用** 二期规划中对齐 roadmap。
:::

> **对标**：[OpenRouter](https://openrouter.ai/) 的统一 API 体验 + **B2B** 租户、合同与**内部运营后台**（OpenRouter 无公开运营台，这部分为商用必备）。  
> **聚合平台体验（部署）**：[http://43.159.57.43/trinityai/](http://43.159.57.43/trinityai/)

## 一句话

**上游多家大模型 → 平台统一 API 出口 → 客户用 Key / 控制台调用**；内部运营负责上架、定价、计量与风控。
...
- [开发者文档（对外）](http://127.0.0.1:5205/docs/) — `apps/trinity-docs`，**不与本产品手册混站**
