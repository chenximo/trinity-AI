...
Create task: **`POST /v1/video/generations`**. Endpoint summary: [Create video generation task](./videos-generations.md). Workflow and polling: [Video generation](../multimodal/video-generation.md).
