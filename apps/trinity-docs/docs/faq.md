...
请求体里的 **`model`** 即**模型 ID** 字符串，须与 [获取模型](./api/models.md) 或 [模型广场](https://trinity.ai/models) 中的可用列表一致，例如 `gpt-5.5`、`hunyuan-image`、`kling-2.6`。详见 [API 概述 · 模型 ID](./api/overview.md#模型-idmodel-字段)。
